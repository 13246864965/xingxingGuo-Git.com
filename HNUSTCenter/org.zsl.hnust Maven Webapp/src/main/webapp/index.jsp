...
<body>
    ...
    <form name="userForm1" action="/HWYL/file/upload" enctype="multipart/form-data" method="post" >
		<div id="newUpload1">
 	...
 	<form name="userForm2" action="/HWYL/file/upload2" enctype="multipart/form-data" method="post"">
 		<div id="newUpload2">
			<input type="file" name="file">
		</div>

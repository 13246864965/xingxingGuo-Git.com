...
public interface IConsultationInfoDao {
    ...
    int insertSelective(ConsultationInfo record);

    ConsultationInfo selectByPrimaryKey(String cConsultationid);

    int updateByPrimaryKeySelective(ConsultationInfo record);

    int updateByPrimaryKeyWithBLOBs(ConsultationInfo record);

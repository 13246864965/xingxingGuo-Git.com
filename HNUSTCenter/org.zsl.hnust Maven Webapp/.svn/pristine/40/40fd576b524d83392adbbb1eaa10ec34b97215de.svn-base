...
public class AmbulanceDeviceServiceImpl implements IAmbulanceDeviceService{
	...
	@Override
	public int insertSelective(AmbulanceDevice record) {
		return ambulanceDeviceDao.insertSelective(record);
	}
	...
	@Override
	public int updateByPrimaryKeySelective(AmbulanceDevice record) {
		return ambulanceDeviceDao.updateByPrimaryKeySelective(record);
	}
